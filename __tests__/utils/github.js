...
class GithubMock {
    ...
    constructor(sandbox) {
        ...
        sandbox.stub(axios.Axios.prototype, 'post').callsFake((url, data) => {
            if (url.endsWith('/git/tags')) {
                ...
                return {
                    data: {
                        html_url: 'https://github.com/this-is-an-html-url',
                    },
                }
            }
        })
    ...
    generateCommitResponse() {
        return {
            ...
            node_id:
                'C_kwDOJaIlXNoAKDUzZGY2ZDg1YTNmOTAxNWVmNDE2Zjk2ODMzMWQzM2RiZWVhYjEzNWQ',
            commit: {
                author: {
                    name: 'OnwerName',
            ...
            html_url:
                'https://github.com/ownerName/repoName/commit/53df6d85a3f9015ef416f968331d33dbeeab135d',
            comments_url:
                'https://api.github.com/repos/ownerName/repoName/commits/53df6d85a3f9015ef416f968331d33dbeeab135d/comments',
            author: null,
            committer: null,
            parents: [
                {
                    ...
                    html_url:
                        'https://github.com/ownerName/repoName/commit/ac500ae1ed612653cc9e9f35a813d1d67260707d',
                },
            ],
            stats: {
                total: 1,
            ...
            files: [
                {
                    ...
                    changes: 1,
                    blob_url:
                        'https://github.com/ownerName/repoName/blob/53df6d85a3f9015ef416f968331d33dbeeab135d/src%2Findex.txt',
                    raw_url:
                        'https://github.com/ownerName/repoName/raw/53df6d85a3f9015ef416f968331d33dbeeab135d/src%2Findex.txt',
                    contents_url:
                        'https://api.github.com/repos/ownerName/repoName/contents/src%2Findex.txt?ref=53df6d85a3f9015ef416f968331d33dbeeab135d',
                ...
                },
                {
                    ...
                    changes: 0,
                    blob_url:
                        'https://github.com/ownerName/repoName/blob/ac500ae1ed612653cc9e9f35a813d1d67260707d/src%2Findex2.txt',
                    raw_url:
                        'https://github.com/ownerName/repoName/raw/ac500ae1ed612653cc9e9f35a813d1d67260707d/src%2Findex2.txt',
                    contents_url:
                        'https://api.github.com/repos/ownerName/repoName/contents/src%2Findex2.txt?ref=ac500ae1ed612653cc9e9f35a813d1d67260707d',
                },
            ],
        }
    }
    ...
    generateRelease(releaseDate, releaseBody, workspaceId) {
        return {
            ...
            assets_url:
                'https://api.github.com/repos/onwerName/repoName/releases/162853025/assets',
            upload_url:
                'https://uploads.github.com/repos/onwerName/repoName/releases/162853025/assets{?name,label}',
            html_url:
                'https://github.com/onwerName/repoName/releases/tag/0.0.0-test1',
            id: 162853025,
            author: {
                login: 'onwerName',
                id: 19176536,
                ...
                avatar_url:
                    'https://avatars.githubusercontent.com/u/19176536?v=4',
                gravatar_id: '',
                url: 'https://api.github.com/users/onwerName',
                html_url: 'https://github.com/onwerName',
                followers_url:
                    'https://api.github.com/users/onwerName/followers',
                following_url:
                    'https://api.github.com/users/onwerName/following{/other_user}',
                gists_url:
                    'https://api.github.com/users/onwerName/gists{/gist_id}',
                starred_url:
                    'https://api.github.com/users/onwerName/starred{/owner}{/repo}',
                subscriptions_url:
                    'https://api.github.com/users/onwerName/subscriptions',
                organizations_url:
                    'https://api.github.com/users/onwerName/orgs',
                repos_url: 'https://api.github.com/users/onwerName/repos',
                events_url:
                    'https://api.github.com/users/onwerName/events{/privacy}',
                received_events_url:
                    'https://api.github.com/users/onwerName/received_events',
                type: 'User',
                site_admin: false,
            },
            ...
            assets: [],
            tarball_url:
                'https://api.github.com/repos/onwerName/repoName/tarball/0.0.0-test1',
            zipball_url:
                'https://api.github.com/repos/onwerName/repoName/zipball/0.0.0-test1',
            body:
                releaseBody ||
                `
