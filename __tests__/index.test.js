...
describe('Main', () => {
    ...
    describe('Github plugin', () => {
        ...
        context('When Github Plugin provided with simple scenario', () => {
            ...
            const githubMock = new GithubMock(sandbox)
        ...
        // github with 3 commits of the partens that needs iterate.
        // github with no release found
        // github with commit not found (should implement retry)
        // github with last release no valid (not from release tool kit).
        // github with tag creation failed
        // github with release creation failed
        // github with wrong commits pattern
        // github with both commit wrong and right commit patterns.
